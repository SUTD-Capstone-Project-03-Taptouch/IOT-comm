...
#define MQTT_SERIAL_RECEIVER_CH "/sensor/instant/sensor1"  //subscribe -:) receives data from broker/esp --> receive pressure matrix values
...
void reconnect() {
  ...
  while (!client.connected()) {
    ...
    if (client.connect(clientId.c_str(), MQTT_USER, MQTT_PASSWORD)) {
      ...
      client.publish("/flask/mqtt/ESPM", "ESPM is setup and ready to go");
      // ... and resubscribe
